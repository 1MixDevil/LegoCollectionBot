...
| Добавить (`/add`) | Одиночное и bulk-добавление |
| Удалить | По артикулу |
| Моя коллекция | Коллаж / Excel |
| Настройки | Переключатели цен, описания, дат |
| Info | Информация о фигурке |
| Update | Обновление каталога из BrickLink |
| Tier-list | Коллаж по списку артикулов |
| Sale / Buy / Search | Запланировано |
